...
function renderMediaGallery() {
  ...
  const items = [
    { type: 'video', src: 'medal/v1.mp4', caption: 'holy..' },
    { type: 'video', src: 'medal/v2.mp4', caption: 'the recall' },
    { type: 'video', src: 'medal/v3.mp4', caption: 'what are you gonna do now' },
    { type: 'video', src: 'medal/v4.mp4', caption: 'i think you are' },
    { type: 'video', src: 'medal/v5.mp4', caption: 'walking around' },
    { type: 'video', src: 'medal/v6.mp4', caption: 'kurwa' },
    { type: 'video', src: 'medal/v7.mp4', caption: 'ye whatever u say' },
    { type: 'video', src: 'medal/v8.mp4', caption: 'scariest lulu alive' },
    { type: 'video', src: 'medal/v9.mp4', caption: 'never in my life' }
  ];
